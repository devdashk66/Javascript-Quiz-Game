...
function QuestionGame() {
  ...
  function handleAnswer(answer) {
    if (answer === correctAnswer) {
      ...
      // If the answer is wrong, reset the score and total questions
      setScore(0);
      setTotalQuestions(0);
    }
    ...
    <div className="flex text-gray-200 flex-col items-center justify-center min-h-screen bg-gray-900">
      <div className="bg-gray-600 rounded-lg shadow-lg p-8 mx-3 relative">
        ...
        <div className="flex flex-row my-6 space-x-4">
          <button
            className="w-full flex items-center justify-center h-12 p-4 mb-2 rounded-lg border border-gray-300 shadow-inner focus:outline-none focus:ring-2 focus:ring-blue-500 button-red-glow"
          ...
          <button
            className="w-full flex items-center justify-center h-12 p-4 rounded-lg border border-gray-300 shadow-inner focus:outline-none focus:ring-2 focus:ring-blue-500 button-red-glow"
        ...
        {totalQuestions > 0 && totalQuestions === score && (
        ...
        {totalQuestions > 0 && totalQuestions !== score && (
          <p className="text-lg font-bold mb-2 text-red-500">
            Sorry, you missed some questions. Better luck next time!
          </p>
        )}
        <div className="mt-4">
          <button
            className="py-3 px-6 bg-gray-600 hover:bg-gray-700 text-gray-200 font-bold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-gray-400"
            onClick={() => {
              setScore(0);
              setTotalQuestions(0);
              generateQuestion();
